...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout() {
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Freq", "Peak Freq", juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f), 20.f));
...
//    juce::AudioParameterChoice(<#const String &parameterID#>, <#const String &parameterName#>, <#const StringArray &choices#>, <#int defaultItemIndex#>)
